              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  {offer.image_url ? (
                    ...
                    <img
                      src={`https://www.google.com/s2/favicons?domain=${(() => { try { return new URL(offer.url).hostname } catch { return '' } })()}&sz=32`}
                      alt=""
                      className="w-5 h-5 opacity-60 group-hover/offer:opacity-100 transition-opacity shrink-0"
                      onError={(e) => (e.currentTarget.style.display = 'none')}
                    />
                  )}
